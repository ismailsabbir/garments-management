...
import "./CartPaymentSucessPage.css";
const CartPaymentSucessPage = () => {
        ...
        <div>
          ...
          <div className="">
            ...
            <div className="cart-total-cost">
              <h6>
                Total Price :{" "}
                <span className="total-cart-tk">{products?.total_price}</span>
              </h6>
            </div>
          </div>
...
export default CartPaymentSucessPage;
