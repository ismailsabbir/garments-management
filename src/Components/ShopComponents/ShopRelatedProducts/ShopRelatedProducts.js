...
const ShopRelatedProducts = ({ oneproduct }) => {
  ...
  const allproduct = singleproducts?.products?.slice(0, 4);
  const categoryid = singleproducts?.category_id;
    ...
    <div className="all-products-con">
      ...
      <div className="row">
        {allproduct?.map((product) => (
          <div className=" shop-single-product col col-12 col-lg-3 col-sm-12 col-md-4">
